    ...
    <div class="lg:pl-72">
      <div
        ...
        <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
          ...
          <PlusCircleIcon class="cursor-pointer col-start-1 row-start-1 size-10 self-center text-patient-page-color"
            aria-hidden="true" @click="openCreateFormDialog" />
            ...
            <Menu as="div" class="relative">
              ...
              <transition enter-active-class="transition ease-out duration-100"
                ...
                <MenuItems
                  ...
                  <button type="button" @click="item.action()" :class="[
                        active ? 'bg-gray-50' : '',
