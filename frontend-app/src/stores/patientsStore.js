  ...
  () => {
    ...
    async function createNewPatient(data){
      ...
      try {
        ...
        formData.append("HasAlergies", data.HasAlergies)
        formData.append("HasSyndromes", data.HasSyndromes)
        formData.append("Pediatrician", data.Pediatrician)
        formData.append("MotherInfo", data.Contact1)
        formData.append("FatherInfo", data.Contact2)
        formData.append("ContactPhones", data.ContactPhones)
        formData.append("Insurance", data.Insurance)
        formData.append("ResidenceAddress", data.ResidenceAddress)
