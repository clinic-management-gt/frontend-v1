<template>
     <div class="flex justify-between items-center mx-6 my-4">
          ...
          <div class="flex justify-between">
               <action-button-solid-icon @click="props.createAction && props.createAction()" icon="PlusIcon"
                    size="h-16 w-16" color="text-patient-page-color" />
               <action-button-solid-icon @click="props.chartAction && props.chartAction()" icon="ChartBarSquareIcon"
                    size="h-16 w-16" color="text-patient-page-color" />
          </div>
     </div>
</template>
