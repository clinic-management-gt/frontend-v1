<template>
  <div>
    <div class="ml-2 max-lg:mt-2 lg:col-span-1">
      ...
      <h2 class="text-sm/6 text-gray-900 pt-2">
        {{ $t("patients.phone-contact") }}
      </h2>
      <div
        v-for="(item, index) in patientPhoneList"
        :key="index"
  ...
  return [
    {
      ...
      value: `${newPatientData.value.names} ${newPatientData.value.lastNames}`,
      css: "col-span-2",
    },
    {
    ...
    },
    {
      ...
      value:
        newPatientData.value.currentGender === 1
          ? "general.male"
          : "general.female",
      isI18n: true,
    },
    {
      name: "patients.family-pediatrician",
      value: newPatientData.value.pediatrician,
    },
    ...
    {
      name: "patients.residence-address",
      value: newPatientData.value.residence,
    },
