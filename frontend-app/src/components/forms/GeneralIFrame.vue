<template>
  <div class="flex flex-col w-full">
    <div>
      <iframe v-if="blobUrl" :src="blobUrl" frameborder="0" :width="customWidth" :height="customHeight"></iframe>
    </div>
...
const { blobUrl, generate } = useBlobAdapter(props.source, { mimeType: 'application/pdf' })
