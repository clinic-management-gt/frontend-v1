...
describe('PatientHistoryLogBox.vue', () => {
     ...
     it('avanza y retrocede de página correctamente', async () => {
          ...
          const nextBtn = wrapper.findAllComponents(ActionButtonSolidIcon).find(b => b.props().icon === 'ChevronRightIcon')
          await nextBtn.trigger('click')
          expect(wrapper.text()).toContain('2 - 3')

          const prevBtn = wrapper.findAllComponents(ActionButtonSolidIcon).find(b => b.props().icon === 'ChevronLeftIcon')
